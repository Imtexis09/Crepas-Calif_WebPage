function validar(){
    ...
    var nombre,apellidos,correo,usuario,clave,telefono,expresion,clave2;
  ...
  edad=document.getElementById("edad").value;
    ...
    if (nombre==="" || apellidos==="" || correo==="" || usuario==="" || clave==="" || telefono==="" || clave2==="" || edad === ""){
    ...
    if (usuario.length>=20 || clave.length>=20 || clave2.length>=20){
